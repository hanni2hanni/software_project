  ...
  <div class="driver">
    ...
    <div class="features">
      ...
      <div class="feature-item small-item">
        ...
        <router-link to="/voice-assistant" class="feature-link">了解更多</router-link>
      </div>
      <div class="feature-item small-item">
        <h2>情感分析系统</h2>
...
.feature-item {
  border: 2px solid #92cdf7; /* 与 App.vue 风格一致 */
  border-radius: 10px;
  padding: 20px;
...
.feature-item:hover {
  ...
  background-color: rgba(255, 255, 255, 0.1); /* 悬停时加深背景 */
}
...
.feature-link:hover {
  background-color: #2780ba; /* 悬停时按钮颜色 */
