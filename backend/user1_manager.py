...
ROLES_PERMISSIONS = {
    "driver": [
        "CONTROL_AC", "PLAY_MUSIC", "PAUSE_MUSIC", "CONFIRM_ACTION", "REJECT_ACTION",
        "START_NAVIGATION", "ANSWER_CALL", "VIEW_CRITICAL_ALERTS", "SET_VOLUME_HIGH", "EXECUTE_COMMAND", # 假设所有指令都属于 EXECUTE_COMMAND 权限
        # ... 驾驶员可以执行的所有动作标签
    ],
    "passenger": [
        "PLAY_MUSIC", "PAUSE_MUSIC", "REQUEST_NAVIGATION_DESTINATION", "SET_VOLUME_MEDIUM", "EXECUTE_PASSENGER_COMMAND", # 乘客特定指令权限
        # 注意：根据实际指令设计，可能需要更细粒度的权限标签
    ],
    "vehicle_maintenance": [ # 车辆维护人员
        "VIEW_SYSTEM_DIAGNOSTICS", "RESET_SYSTEM_SETTINGS", "RUN_TESTS"
    ],
